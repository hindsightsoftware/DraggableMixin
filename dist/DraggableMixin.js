...
var DraggableMixin = function (React) {
  ...
  var DraggableList = React.createClass({displayName: 'DraggableList',
    ...
    render: function () {
      ...
      return (React.DOM.ul( {id:"map-container"}, column.map(function (item) {
        return (React.DOM.li( {className:item.className}, item.content,
          React.DOM.ul( {'data-id':item.content, style:{display: "block"}}, item.items.map(function (listItem) {
